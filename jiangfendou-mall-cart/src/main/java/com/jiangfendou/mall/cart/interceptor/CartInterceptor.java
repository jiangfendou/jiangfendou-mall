package com.jiangfendou.mall.cart.interceptor;

import static com.jiangfendou.common.constant.AuthServerConstant.LOGIN_USER;
import static com.jiangfendou.common.constant.CartConstant.TEMP_USER_COOKIE_NAME;
import com.jiangfendou.common.constant.CartConstant;
...
public class CartInterceptor implements HandlerInterceptor {
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        ...
        if (!userInfoTo.getTempUser()) {
            ...
            //扩大作用域
            cookie.setDomain("jiangfendou.com");
            //设置过期时间
